        ...
        o !== void 0 &&
          ...
          (N(t[l]) && N(s[l])
            ? s[l].__swiper__
              ...
              : _(t[l], s[l])
            : !N(t[l]) && N(s[l])
            ? ((t[l] = {}), s[l].__swiper__ ? (t[l] = s[l]) : _(t[l], s[l]))
            : (t[l] = s[l]));
      }
    }
  }
...
function ke(t) {
  ...
  return (
    !d &&
      ...
      d || (d = [0, 1, "13_0_0"]),
      (h = !1)),
    c && !u && ((a.os = "android"), (a.android = !0)),
    (d || p || f) && ((a.os = "ios"), (a.ios = !0)),
    a
  );
}
function Te(t) {
  return t === void 0 && (t = {}), Y || (Y = ke(t)), Y;
}
let q;
function Be() {
  const t = A(),
        ...
        ((n = new ResizeObserver((f) => {
          a = r.requestAnimationFrame(() => {
            ...
            let h = p,
              m = u;
            f.forEach((T) => {
              let { contentBoxSize: g, contentRect: b, target: w } = T;
              (w && w !== e.el) ||
                ((h = b ? b.width : (g[0] || g).inlineSize),
                (m = b ? b.height : (g[0] || g).blockSize));
            }),
              (h !== p || m !== u) && l();
          });
        })),
...
function je() {
  const t = this;
  function e(v, P) {
    return parseFloat(v.getPropertyValue(t.getDirectionLabel(P)) || 0);
  }
  const i = t.params,
    { wrapperEl: s, slidesEl: r, size: n, rtlTranslate: a, wrongRTL: l } = t,
    o = t.virtual && i.virtual.enabled,
    c = o ? t.virtual.slides.length : t.slides.length,
    d = D(r, `.${t.params.slideClass}, swiper-slide`),
    f = o ? t.virtual.slides.length : d.length;
  let p = [];
  const u = [],
    h = [];
  ...
  typeof w == "string" && w.indexOf("%") >= 0
    ...
    i.centeredSlides &&
      i.cssMode &&
      (R(s, "--swiper-centered-offset-before", ""),
  ...
  const E =
    ...
    Object.keys(i.breakpoints).filter(
      (v) => typeof i.breakpoints[v].slidesPerView < "u"
    ).length > 0;
  for (let v = 0; v < f; v += 1) {
    I = 0;
    let P;
    if (
      (d[v] && (P = d[v]),
      O && t.grid.updateSlide(v, P, d),
      !(d[v] && k(P, "display") === "none"))
    ) {
      if (i.slidesPerView === "auto") {
        E && (d[v].style[t.getDirectionLabel("width")] = "");
        const C = getComputedStyle(P),
          x = P.style.transform,
          L = P.style.webkitTransform;
        if (
          (x && (P.style.transform = "none"),
          L && (P.style.webkitTransform = "none"),
          i.roundLengths)
        )
          I = t.isHorizontal() ? ce(P, "width") : ce(P, "height");
        else {
          const z = e(C, "width"),
            V = e(C, "padding-left"),
            ye = e(C, "padding-right"),
            ne = e(C, "margin-left"),
            oe = e(C, "margin-right"),
            le = C.getPropertyValue("box-sizing");
          if (le && le === "border-box") I = z + ne + oe;
          else {
            const { clientWidth: Ee, offsetWidth: Pe } = P;
            I = z + V + ye + ne + oe + (Pe - Ee);
          }
        }
        x && (P.style.transform = x),
          L && (P.style.webkitTransform = L),
          i.roundLengths && (I = Math.floor(I));
      } else
        (I = (n - (i.slidesPerView - 1) * w) / i.slidesPerView),
          i.roundLengths && (I = Math.floor(I)),
          d[v] && (d[v].style[t.getDirectionLabel("width")] = `${I}px`);
      d[v] && (d[v].swiperSlideSize = I),
        h.push(I),
        i.centeredSlides
          ? ((y = y + I / 2 + S / 2 + w),
            S === 0 && v !== 0 && (y = y - n / 2 - w),
  ...
  if (
    ((t.virtualSize = Math.max(t.virtualSize, n) + T),
    a &&
      l &&
    ...
    O && t.grid.updateWrapperSize(I, p),
    !i.centeredSlides)
  ) {
    const v = [];
  ...
  if (o && i.loop) {
    ...
    if (i.slidesPerGroup > 1) {
      ...
      for (let x = 0; x < P; x += 1) p.push(p[p.length - 1] + C);
    }
    for (let P = 0; P < t.virtual.slidesBefore + t.virtual.slidesAfter; P += 1)
      i.slidesPerGroup === 1 && p.push(p[p.length - 1] + v),
  ...
  if (
    ...
    const v = -t.snapGrid[0],
      P = -t.slidesGrid[0];
    (t.snapGrid = t.snapGrid.map((C) => C + v)),
      (t.slidesGrid = t.slidesGrid.map((C) => C + P));
  }
  if (
    ...
    const v = `${i.containerModifierClass}backface-hidden`,
      P = t.el.classList.contains(v);
    f <= i.maxBackfaceHiddenSlides
      ? P || t.el.classList.add(v)
      : P && t.el.classList.remove(v);
  }
}
function We(t) {
  const e = this,
  ...
  for (let o = 0; o < s.length; o += 1) {
    ...
    const f =
      ...
      T =
        ...
        (h > 1 && h <= e.size) ||
        (u <= 0 && h >= e.size);
    T && (e.visibleSlides.push(c), e.visibleSlidesIndexes.push(o)),
      fe(c, T, i.slideVisibleClass),
      fe(c, m, i.slideFullyVisibleClass),
      (c.progress = r ? -f : f),
...
function Ue() {
  const t = this,
    ...
    l = (f) => D(s, `.${i.slideClass}${f}, swiper-slide${f}`)[0];
  let o, c, d;
  if (n)
    if (i.loop) {
  ...
  o &&
    (a ||
      ((d = Ge(o, `.${i.slideClass}, swiper-slide`)[0]),
      i.loop && !d && (d = e[0]),
      (c = _e(o, `.${i.slideClass}, swiper-slide`)[0]),
      i.loop && !c === 0 && (c = e[e.length - 1]))),
    e.forEach((f) => {
      X(f, f === o, i.slideActiveClass),
        X(f, f === d, i.slideNextClass),
        X(f, f === c, i.slidePrevClass);
    }),
    t.emitSlidesClasses();
}
const $ = (t, e) => {
...
function Je(t) {
  ...
  if ((typeof o > "u" && (o = Ke(e)), s.indexOf(i) >= 0)) c = s.indexOf(i);
  else {
  ...
  let p;
  if (e.virtual && r.virtual.enabled && r.loop) p = d(o);
  else if (f) {
    const u = e.slides.filter((m) => m.column === o)[0];
  ...
  if (
    ...
    if (e === 0) l[f ? "scrollLeft" : "scrollTop"] = -d;
      ...
      if (!n.support.smoothScroll)
        return (
          we({ swiper: n, targetPosition: -d, side: f ? "left" : "top" }), !0
        );
...
function lt(t, e) {
  ...
  s.cssMode ||
    ...
    be({ swiper: i, runCallbacks: t, direction: e, step: "Start" }));
}
function at(t, e) {
  t === void 0 && (t = !0);
  const i = this,
  ...
  (i.animating = !1),
    !s.cssMode &&
      (i.setTransition(0),
      be({ swiper: i, runCallbacks: t, direction: e, step: "End" }));
}
var dt = { setTransition: ot, transitionStart: lt, transitionEnd: at };
function ct(t, e, i, s, r) {
  t === void 0 && (t = 0),
    i === void 0 && (i = !0),
  ...
  let T = m + Math.floor((a - m) / n.params.slidesPerGroup);
  ...
  if (
    ...
    return !1;
  a !== (d || 0) && i && n.emit("beforeSlideChangeStart"), n.updateProgress(g);
  let b;
  a > f ? (b = "next") : a < f ? (b = "prev") : (b = "reset");
  const w = n.virtual && n.params.virtual.enabled;
  if (!(w && r) && ((p && -g === n.translate) || (!p && g === n.translate)))
    return (
      n.updateActiveIndex(a),
      l.autoHeight && n.updateAutoHeight(),
      n.updateSlidesClasses(),
      l.effect !== "slide" && n.setTranslate(g),
  ...
  if (l.cssMode) {
    ...
    if (e === 0)
      ...
      if (!n.support.smoothScroll)
        return (
          we({ swiper: n, targetPosition: M, side: S ? "left" : "top" }), !0
        );
      u.scrollTo({ [S ? "left" : "top"]: M, behavior: "smooth" });
    }
    return !0;
  }
  return (
...
function ft(t, e, i, s) {
  ...
  if (r.params.loop)
    if (r.virtual && r.params.virtual.enabled) a = a + r.virtual.slidesBefore;
      ...
      let f = o - l < d;
      if (
        (c && (f = f || l < Math.ceil(d / 2)),
        s && c && r.params.slidesPerView !== "auto" && !n && (f = !1),
        f)
      ) {
        const p = c
          ? l < r.activeIndex
...
function mt(t, e, i, s) {
  ...
  if (o >= r.snapGrid[l]) {
    const c = r.snapGrid[l],
      d = r.snapGrid[l + 1];
    o - c > (d - c) * s && (n += r.params.slidesPerGroup);
  } else {
    ...
    (n = parseInt(t.clickedSlide.getAttribute("data-swiper-slide-index"), 10)),
      e.centeredSlides
        ? r < t.loopedSlides - s / 2 ||
          ...
          ? (t.loopFix(),
            (r = t.getSlideIndex(
              D(i, `${a}[data-swiper-slide-index="${n}"]`)[0]
            )),
            Z(() => {
              t.slideTo(r);
            }))
...
function wt(t) {
  ...
  const r = () => {
      D(s, `.${i.slideClass}, swiper-slide`).forEach((f, p) => {
...
function St(t) {
  ...
  m === "auto"
    ...
    : ((m = Math.ceil(parseFloat(u.slidesPerView, 10))),
      h && m % 2 === 0 && (m = m + 1));
  const T = u.slidesPerGroupAuto ? m : u.slidesPerGroup;
  let g = T;
  g % T !== 0 && (g += T - (g % T)),
  ...
  typeof n > "u"
    ? (n = o.getSlideIndex(
        c.filter((x) => x.classList.contains(u.slideActiveClass))[0]
      ))
    : (S = n);
  const M = s === "next" || !s,
    O = s === "prev" || !s;
  let I = 0,
    E = 0;
  const v = b ? Math.ceil(c.length / u.grid.rows) : c.length,
    C = (b ? c[n].column : n) + (h && typeof r > "u" ? -m / 2 + 0.5 : 0);
  if (C < g) {
    I = Math.max(g - C, T);
    for (let x = 0; x < g - C; x += 1) {
      const L = x - Math.floor(x / v) * v;
      if (b) {
        const z = v - L - 1;
        for (let V = c.length - 1; V >= 0; V -= 1)
          c[V].column === z && w.push(V);
      } else w.push(v - L - 1);
    }
  } else if (C + m > v - g) {
    E = Math.max(C - (v - g * 2), T);
    for (let x = 0; x < E; x += 1) {
      const L = x - Math.floor(x / v) * v;
      b
        ? c.forEach((z, V) => {
  ...
  if (
    ...
    u.slidesPerView === "auto"
      ? o.updateSlides()
      : b &&
        ((w.length > 0 && O) || (y.length > 0 && M)) &&
        o.slides.forEach((x, L) => {
    ...
    if (w.length > 0 && O) {
      if (typeof e > "u") {
        const x = o.slidesGrid[S],
          z = o.slidesGrid[S + I] - x;
        l
        ...
        const x = b ? w.length / u.grid.rows : w.length;
...
var bt = { loopCreate: wt, loopFix: St, loopDestroy: Tt };
function xt(t) {
  const e = this;
  if (
...
var Et = { setGrabCursor: xt, unsetGrabCursor: yt };
function Pt(t, e) {
  e === void 0 && (e = this);
  function i(s) {
...
function Mt(t) {
  ...
  if (n.noSwiping && (p ? Pt(f, o) : o.closest(f))) {
    e.allowClick = !0;
    return;
  }
  ...
  const T = m && e.allowTouchMove && n.touchStartPreventDefault;
...
function Ct(t) {
  ...
  if (o.type === "touchmove") {
    if (
      ((c = [...o.changedTouches].filter((M) => M.identifier === s.touchId)[0]),
  ...
  if (!i.allowTouchMove) {
    o.target.matches(s.focusableElements) || (i.allowClick = !1),
      s.isTouched &&
        (Object.assign(n, { startX: d, startY: f, currentX: d, currentY: f }),
        (s.touchStartTime = H()));
    return;
  }
        ...
        s.currentTranslate > i.minTranslate() &&
          ...
          r.resistance &&
            (s.currentTranslate =
              i.minTranslate() -
              1 +
              (-i.minTranslate() + s.startTranslate + h) ** S)))
      : h < 0 &&
        (g &&
          b &&
          !w &&
        ...
        s.currentTranslate < i.maxTranslate() &&
          ...
          r.resistance &&
            (s.currentTranslate =
              i.maxTranslate() +
              1 -
              (i.maxTranslate() - s.startTranslate - h) ** S))),
...
function It(t) {
  ...
  if (s.type === "touchend" || s.type === "touchcancel") {
    if (
      ((r = [...s.changedTouches].filter((S) => S.identifier === i.touchId)[0]),
  ...
  for (
    ...
    typeof c[S + M] < "u"
      ? (h || (u >= c[S] && u < c[S + M])) && ((m = S), (T = c[S + M] - c[S]))
      : (h || u >= c[S]) && ((m = S), (T = c[c.length - 1] - c[c.length - 2]));
  }
  let g = null,
    b = null;
  a.rewind &&
  ...
  if (p > a.longSwipesMs) {
    ...
    e.swipeDirection === "next" &&
      (w >= a.longSwipesRatio
        ? e.slideTo(a.rewind && e.isEnd ? g : m + y)
        : e.slideTo(m)),
      e.swipeDirection === "prev" &&
        (w > 1 - a.longSwipesRatio
          ? e.slideTo(m + y)
          : b !== null && w < 0 && Math.abs(w) > a.longSwipesRatio
          ? e.slideTo(b)
          : e.slideTo(m));
  } else {
    if (!a.shortSwipes) {
    ...
    (s.target === e.navigation.nextEl || s.target === e.navigation.prevEl)
      ? s.target === e.navigation.nextEl
        ? e.slideTo(m + y)
        : e.slideTo(m)
      : (e.swipeDirection === "next" && e.slideTo(g !== null ? g : m + y),
...
function _t() {
  const t = this,
    { params: e } = t;
  (t.onTouchStart = Mt.bind(t)),
    (t.onTouchMove = Ct.bind(t)),
    (t.onTouchEnd = It.bind(t)),
    (t.onDocumentTouchStart = At.bind(t)),
    e.cssMode && (t.onScroll = Ot.bind(t)),
    (t.onClick = Lt.bind(t)),
    (t.onLoad = zt.bind(t)),
    xe(t, "on");
}
...
var Dt = { attachEvents: _t, detachEvents: Gt };
...
function Vt() {
  ...
  c && !d
    ...
    ["navigation", "pagination", "scrollbar"].forEach((w) => {
      ...
      const y = s[w] && s[w].enabled,
        S = o[w] && o[w].enabled;
      y && !S && t[w].disable(), !y && S && t[w].enable();
    });
  const h = o.direction && o.direction !== s.direction,
    m = s.loop && (o.slidesPerView !== s.slidesPerView || h),
    T = s.loop;
  h && i && t.changeDirection(), _(t.params, o);
...
function kt(t, e, i) {
  ...
  for (let l = 0; l < a.length; l += 1) {
    ...
    e === "window"
      ? r.matchMedia(`(min-width: ${c}px)`).matches && (s = o)
      : c <= i.clientWidth && (s = o);
  }
  return s || "max";
}
var Bt = { setBreakpoint: Vt, getBreakpoint: kt };
function Ft(t, e) {
  const i = [];
  return (
    t.forEach((s) => {
...
var $t = { addClasses: Nt, removeClasses: Rt };
function Ht() {
  const t = this,
...
class G {
  constructor() {
    ...
    (l.__swiper__ = !0),
      (l.support = Se()),
      (l.device = Te({ userAgent: i.userAgent })),
      (l.browser = Fe()),
      (l.eventsListeners = {}),
  ...
  getSlideIndex(e) {
    const { slidesEl: i, params: s } = this,
      r = D(i, `.${s.slideClass}, swiper-slide`),
      n = de(r[0]);
    return de(e) - n;
  }
  ...
  recalcSlides() {
    ...
    e.slides = D(i, `.${s.slideClass}, swiper-slide`);
  }
  enable() {
    const e = this;
    e.enabled ||
  ...
  slidesPerViewDynamic(e, i) {
    ...
    if (r.centeredSlides) {
      let f = n[c] ? Math.ceil(n[c].swiperSlideSize) : 0,
        p;
      for (let u = c + 1; u < n.length; u += 1)
        n[u] &&
          !p &&
          ((f += Math.ceil(n[u].swiperSlideSize)), (d += 1), f > o && (p = !0));
      for (let u = c - 1; u >= 0; u -= 1)
        n[u] &&
          !p &&
          ((f += n[u].swiperSlideSize), (d += 1), f > o && (p = !0));
    } else if (e === "current")
      for (let f = c + 1; f < n.length; f += 1)
        (i ? a[f] + l[f] - a[c] < o : a[f] - a[c] < o) && (d += 1);
    else for (let f = c - 1; f >= 0; f -= 1) a[c] - a[f] < o && (d += 1);
    return d;
  }
  update() {
    const e = this;
  ...
  mount(e) {
    ...
    return (
      !a &&
        ...
        s.append(a),
        D(s, `.${i.params.slideClass}`).forEach((l) => {
          a.append(l);
        })),
      Object.assign(i, {
        el: s,
        ...
        wrongRTL: k(a, "display") === "-webkit-box",
      }),
      !0
    );
  }
  ...
  static use(e) {
    return Array.isArray(e)
      ? (e.forEach((i) => G.installModule(i)), G)
      : (G.installModule(e), G);
  }
}
...
function se(t, e) {
  ...
  Object.keys(e)
    ...
    .forEach((s) => {
      typeof t[s] > "u"
        ? (t[s] = e[s])
        : F(e[s]) && F(t[s]) && Object.keys(e[s]).length > 0
        ? e[s].__swiper__
          ? (t[s] = e[s])
          : se(t[s], e[s])
        : (t[s] = e[s]);
...
function ti(t) {
  ...
  r.includes("loop") &&
    e.isElement &&
    (d.loop && !s.loop ? (S = !0) : !d.loop && s.loop ? (M = !0) : (O = !0)),
    c.forEach((E) => {
      if (F(d[E]) && F(s[E]))
        Object.assign(d[E], s[E]),
    ...
    r.includes("children") && i && h && d.virtual.enabled
      ? ((h.slides = i), h.update(!0))
      : r.includes("virtual") &&
        h &&
        d.virtual.enabled &&
        (i && (h.slides = i), h.update(!0)),
    r.includes("children") && i && d.loop && (O = !0),
    T && m.init() && m.update(!0),
...
function ii(t, e, i) {
  ...
  se(s, ie);
  const n = [...Yt, "on"],
    a = n.map((o) => o.replace(/_/, ""));
  n.forEach((o) => {
    (o = o.replace("_", "")), typeof t[o] < "u" && (r[o] = t[o]);
  });
  const l = [...t.attributes];
  return (
    typeof e == "string" &&
      typeof i < "u" &&
      l.push({ name: e, value: F(i) ? { ...i } : i }),
    l.forEach((o) => {
      const c = ge.filter((d) => o.name.indexOf(`${d}-`) === 0)[0];
      if (c) {
        const d = Q(c),
          f = Q(o.name.split(`${c}-`)[1]);
        typeof r[d] > "u" && (r[d] = {}),
          r[d] === !0 && (r[d] = { enabled: !0 }),
          (r[d][f] = me(o.value));
      } else {
        ...
        const f = me(o.value);
        r[d] && ge.includes(o.name) && !F(f)
          ? (r[d].constructor !== Object && (r[d] = {}), (r[d].enabled = !!f))
          : (r[d] = f);
      }
    }),
    se(s, r),
